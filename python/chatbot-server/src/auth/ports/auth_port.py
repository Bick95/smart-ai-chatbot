...
class AuthPort(Protocol):
    ...
    async def get_user_by_email(self, email: str) -> AuthUser | None:
        ...
        Note: For Supabase without AUTHENTICATION_SERVICE_DATABASE_URL, this fetches all users
        via list_users (inefficient). Set AUTHENTICATION_SERVICE_DATABASE_URL for efficient
